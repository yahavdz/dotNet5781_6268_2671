    ...
    public partial class BusItem : UserControl
    {
        ...
        private void Button_Fuel(object sender, RoutedEventArgs e)
        {
            ...
            if (currentBus.statusNow == status.readyToGo)
            {
                ...
                this.currentBus.statusNow = status.refuelingNow;
        ...
        private void inRefuel()
        {
            ...
            Dispatcher.BeginInvoke((Action)(() => tbStatus.Text = "Ready To Go")); // use dispatcher to access the TextBox in different threads
        }
